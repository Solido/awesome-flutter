...
<p align="center">
  <a href="https://stackoverflow.com/questions/tagged/flutter?sort=votes">
    <img alt="StackOverflow" src="https://img.shields.io/badge/StackOverflow-8223-orange.svg" />
  </a>
  <a href="https://github.com/search?q=flutter+language%3Adart&type=Repositories">
    <img alt="Github Repositories" src="https://img.shields.io/badge/Repos-12989-brightgreen.svg" />
  </a>
...
- [From Install to ListView](https://medium.com/@develodroid/flutter-i-intro-and-install-a8bf6dfcc7c8) [752 claps👏] - Full series of 4 articles by [Chema Rubio](https://twitter.com/develodroid).
...
- [Rendering Pipeline](https://www.youtube.com/watch?v=UUfXWzp0-DU) [207👍] - Engine architecture by Adam Barth.
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) [1593⭐] - Simple basic isolated apps for devs by [Nishant Srivastava](https://github.com/nisrulz).
...
- [Sticky Header](https://github.com/letsar/flutter_sticky_header) [129⭐] - Sliver based sticky headers by [Romain Rastel](https://github.com/letsar).
...
- [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation) [307⭐] - Smooth animation from login to home by [Ruchika Gupta](https://github.com/geekruchika).
...
- [Offline](https://github.com/jogboms/flutter_offline) [132⭐] - Tidy utility to handle offline/online connectivity by [Jeremiah Ogbomo](https://twitter.com/jogboms).
...
- [Photo View](https://github.com/renancaraujo/photo_view) [206⭐] - Scalable image view with loading placeholder by [Renan C. Araújo](https://github.com/renancaraujo).
...
- [Map](https://github.com/apptreesoftware/flutter_map) [444⭐] - Solution based on [Leaflet](http://leafletjs.com/) and customizable by [AppTree Software](https://github.com/apptreesoftware).
...
- [Charts](https://github.com/google/charts) [384⭐] - By Google Charts Team.
...
- [Fluro](https://github.com/goposse/fluro) [599⭐] - The brightest, hippest, coolest router for Flutter with Navigation, wildcard, query, transitions by [Posse](http://goposse.com).
...
- [Zefyr](https://github.com/memspace/zefyr) [282⭐] - Soft and gentle rich text editing by [Memspace](https://github.com/memspace/zefyr).
...
- [Audio Plugin](https://github.com/rxlabz/audioplayer) [177⭐] - Beta by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) [248⭐] - WebRTC plugin for iOS/Android by [CloudWebRtc](https://github.com/cloudwebrtc).
...
- [TodoMVC](https://github.com/brianegan/flutter_architecture_samples) [1582⭐] - TODO application ready to go with different flavors : Vanilla, Redux, built_redux by [Brian Egan](https://github.com/brianegan).
...
- [UI Challenges](https://github.com/tomialagbe/flutter_ui_challenges) [476⭐] - Profile, Travel, Food App by [Tomi Alagbe](https://github.com/tomialagbe).
...
- [UI Kit](https://github.com/iampawan/Flutter-UI-Kit) [1580⭐] - Collection of useful UIs in a UIKit by [Pawan Kumar](https://github.com/iampawan).
- [Book](https://github.com/putraxor/flutter-book-app) [95⭐] - Bookshelf by [Ardiansyah Putra](https://github.com/putraxor).
- [The Gorgeous Login](https://github.com/huextrat/TheGorgeousLogin) [337⭐] - Design and smooth login template by [Hugo Extrat](https://github.com/huextrat).
...
- [WebView](https://github.com/dart-flitter/flutter_webview_plugin) [384⭐] - Render web content by [Hadrien Lejard](https://twitter.com/HadrienLejard).
...
- [Blue](https://github.com/pauldemarco/flutter_blue) [326⭐] - Bluetooth by [Paul DeMarco](https://github.com/pauldemarco).
...
- [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) [91⭐] - Push notification service by [OneSignal](https://github.com/OneSignal).
...
- [Bloc](https://github.com/felangel/bloc) [176⭐] - Collection of packages that help implement the BLoC design pattern by [Felix Angelov](https://github.com/felangel).
...
- [Redux.dart](https://github.com/johnpryan/redux.dart) [205⭐] - Port of Redux to Dart with an ecosystem of middleware, Flutter integrations, and time traveling dev tools by [John Ryan](https://github.com/johnpryan) and [Brian Egan](https://gitlab.com/users/brianegan/projects).
- [Redux](https://github.com/brianegan/flutter_redux) [465⭐] - Built to work with [redux.dart](https://github.com/johnpryan/redux.dart), utilities that allow you to easily consume a Redux Store to build Widgets.
...
- [Graphql_flutter](https://github.com/zino-app/graphql-flutter) [416⭐] - Implementation of the GraphQL spec by [Zino App B.V.](https://github.com/zino-app).
...
- [SpinKit](https://github.com/jogboms/flutter_spinkit) [411⭐] - Animated loading indicators by [Jeremiah Ogbomo](https://twitter.com/jogboms).
...
- [Planets](https://github.com/sergiandreplace/flutter_planets_tutorial) [307⭐] - Planet exploration that demonstrate rich UI by [Sergi Martínez](http://sergiandreplace.com).
...
- [DroidKaigi2018-flutter](https://github.com/konifar/droidkaigi2018-flutter) [343⭐] - Unofficial conference app for DroidKaigi 2018 Tokyo by [konifar](https://github.com/konifar).
...
- [FlutterGram](https://github.com/mdanics/fluttergram) [323⭐] - Complete Instagram based on Firestore & Google Functions by [MDanics](https://github.com/mdanics).
...
- [Trace](https://github.com/trentpiercy/trace) [135⭐] - Modern and powerful crypto portfolio & market explorer by [Trent Piercy](https://github.com/trentpiercy).
...
- [Voice - Animal Rights Directory](https://github.com/hitherejoe/Voice) - flutter project demonstrating tailored native experiences by [Joe Birch](https://github.com/hitherejoe).

### Block / Angular / PWA

- [InKino](https://github.com/roughike/inKino) [1523⭐] - Movie app with flutter_redux, animations and unit tests by [Iiro Krankka](https://github.com/roughike).
...
- [Desktop Embedding](https://github.com/google/flutter-desktop-embedding) [2424⭐] - Desktop implementations of the Flutter embedding API by Google.
- [Golang Desktop Embedder](https://github.com/Drakirus/go-flutter-desktop-embedder) [416⭐] - Golang embedder for desktop by [Pierre Champion](https://github.com/Drakirus).
...
- [The One](https://www.youtube.com/watch?v=sIIgtClYq0s) [185👍]
