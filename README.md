...
<p align="center">
  <a href="https://stackoverflow.com/questions/tagged/flutter?sort=votes">
    <img alt="StackOverflow" src="https://img.shields.io/badge/StackOverflow-6138-orange.svg" />
  </a>
...
- [Firebase](https://www.youtube.com/watch?v=p4yLzYwy_4g) [398👍] - Firebase live coding.
...
- [Rendering Pipeline](https://www.youtube.com/watch?v=UUfXWzp0-DU) [171👍] - Engine architecture by Adam Barth.
...
- [Rendering Engine Tutorial](https://medium.com/saugo360/flutters-rendering-engine-a-tutorial-part-1-e9eff68b825d) [240👏] - Flutter's Rendering Engine: A Tutorial by [AbdulRahman AlHamali](https://github.com/AbdulRahmanAlHamali/).
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) [1188★] - Simple basic isolated apps for devs by [Nishant Srivastava](https://github.com/nisrulz).

### UI

- [3D Object](https://github.com/hemanthrajv/flutter_3d_obj) [37★] - Renders a wavefront .obj on to a canvas by [Hemanth Raj](https://www.linkedin.com/in/hemanthrajv).
...
- [StaggeredGridView](https://github.com/letsar/flutter_staggered_grid_view) [229★] - GridView with tiles of variable sizes by [Romain Rastel](https://github.com/letsar).
- [Sticky Header](https://github.com/letsar/flutter_sticky_header) [100★] - Sliver based sticky headers by [Romain Rastel](https://github.com/letsar).
- [Radial Menu](https://github.com/xqwzts/flutter_radial_menu) [116★] - Animated Radial Menu by [Victor Choueiri](https://github.com/xqwzts).
- [Tinder Cards](https://github.com/Ivaskuu/tinder_cards) [114★] - Tinder like cards swipe effect by [Ivascu Adrian](https://github.com/Ivaskuu).
- [Sticky Headers](https://github.com/slightfoot/flutter_sticky_headers) [141★] - Configurable sticky headers by [Simon Lightfoot](http://www.devangels.london/).
- [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation) [245★] - Smooth animation from login to home by [Ruchika Gupta](https://github.com/geekruchika).
...
- [Side Header List](https://github.com/renefloor/side_header_list_view) [86★] - Listview with sticky headers by [Rene Floor](https://github.com/renefloor).
- [Shimmer](https://github.com/hnvn/flutter_shimmer) [155★] - Shimmer effect while content is loading by [HungHD](https://github.com/hnvn).
- [Flip Panel](https://github.com/hnvn/flutter_flip_panel) [73★] - Flip panel with built-in animation by [HungHD](https://github.com/hnvn).
...
- [Calendar Widget](https://github.com/pinkfish/flutter_calendar) [33★] - Calendar widget by [David Bennett](https://github.com/pinkfish).
...
- [Slidable](https://github.com/letsar/flutter_slidable) [234★] - Slidable list item with left and right slide actions by [Romain Rastel](https://github.com/letsar).
...
- [Carousel Slider](https://github.com/serenader2014/flutter_carousel_slider) [89★] - Carousel slider widget, support infinite scroll and custom child widget by [serenader](https://github.com/serenader2014).
- [Parallax Image](https://github.com/pulyaevskiy/parallax-image) [77★] - Image parallax by [Anatoly Pulyaevskiy](https://github.com/pulyaevskiy).
- [Photo View](https://github.com/renancaraujo/photo_view) [136★] - Scalable image view with loading placeholder by [Renan C. Araújo](https://github.com/renancaraujo).
...
- [Image Cropper](https://github.com/hnvn/flutter_image_cropper) [132★] - Crop your images support ratio, rotation, zoom by [HungHD](https://github.com/hnvn).
- [Cached Network Image](https://github.com/renefloor/flutter_cached_network_image) [163★] - Show images from the internet and keep them in the cache directory by.
...
- [Circular Chart](https://github.com/xqwzts/flutter_circular_chart) [122★] - Animated radial and pie charts by [Victor Choueiri](https://github.com/xqwzts).
...
- [Sparkline](https://github.com/xqwzts/flutter_sparkline) [73★] - Sparkline by [Victor Choueiri](https://github.com/xqwzts).
- [Charts](https://github.com/google/charts) [287★] - By Google Charts Team.
- [Flutter Plot](https://github.com/RCHowell/flutter_plot) [13★] - Pretty plots by [R. C. Howell](https://github.com/RCHowell/).
- [Candlesticks](https://github.com/trentpiercy/flutter-candlesticks) [57★] - OHLC and Trade Volume Charts by [Trent Piercy](https://github.com/trentpiercy).
...
- [Fluro](https://github.com/goposse/fluro) [484★] - The brightest, hippest, coolest router for Flutter with Navigation, wildcard, query, transitions by [Posse](http://goposse.com).
...
- [Login](https://github.com/AppleEducate/flutter_login) [159★] - FaceID, TouchID, and Fingerprint Reader by [Rody Davis](http://appleeducate.com).
...
- [Facebook Login](https://github.com/roughike/flutter_facebook_login) [103★] - Authenticate with native Android & iOS Facebook login SDKs by [Iiro Krankka](https://github.com/roughike).
...
- [SimpleAuth](https://github.com/Clancey/simple_auth) [40★] - Azure Active Directory, Amazon, Dropbox, Facebook, Github, Google, Instagram, Linked In, Microsoft Live Connect, Github, OAuth, Basic Auth by [James Clancey](https://github.com/Clancey).

### Text & Rich Content

- [Markdown](https://github.com/flutter/flutter_markdown) [103★] - Markdown renderer for Flutter. It supports the original format, but no inline html.
...
- [Zefyr](https://github.com/memspace/zefyr) [205★] - Soft and gentle rich text editing by [Memspace](https://github.com/memspace/zefyr).
...
- [Chewie](https://github.com/brianegan/chewie) [136★] - Provides low-level access to video playback by [Brian Egan](https://github.com/brianegan).
...
- [Mates](https://github.com/CodemateLtd/FlutterMates) [207★] - How to load profiles from the randomuser.me API and a nice profile details page by [Iiro Krankka](https://github.com/roughike).
- [Weather](https://github.com/alessandroaime/Weather) [68★] - Weather app to learn how to use Canvas and Animation by [Alessandro Aime](https://github.com/alessandroaime).
- [TodoMVC](https://github.com/brianegan/flutter_architecture_samples) [1134★] - TODO application ready to go with different flavors : Vanilla, Redux, built_redux by [Brian Egan](https://github.com/brianegan).
- [Restaurant Menu](https://github.com/braulio94/menu_flutter) [286★] - Restaurant menu by [Braulio Cassule](https://github.com/braulio94).
- [UI Challenges](https://github.com/tomialagbe/flutter_ui_challenges) [399★] - Profile, Travel, Food App by [Tomi Alagbe](https://github.com/tomialagbe).
...
- [Dashboard](https://github.com/Ivaskuu/dashboard) [225★] - Dashboard and Shop Items by [Ivascu Adrian](https://github.com/Ivaskuu).
- [Todo](https://github.com/littlemarc2011/FlutterTodo) [158★] - Todo template from Dribble by [Marc L](https://www.marc-little.com/).
- [Card Swipe Animation](https://github.com/geekruchika/FlutterCardSwipe) [101★] - Swipe cards template by [Ruchika Gupta](https://github.com/geekruchika).
- [UI Kit](https://github.com/iampawan/Flutter-UI-Kit) [1178★] - Collection of useful UIs in a UIKit by [Pawan Kumar](https://github.com/iampawan).
- [Book](https://github.com/putraxor/flutter-book-app) [65★] - Bookshelf by [Ardiansyah Putra](https://github.com/putraxor).
- [The Gorgeous Login](https://github.com/huextrat/TheGorgeousLogin) [216★] - Design and smooth login template by [Hugo Extrat](https://github.com/huextrat).
...
- [WebView](https://github.com/dart-flitter/flutter_webview_plugin) [306★] - Render web content by [Hadrien Lejard](https://twitter.com/HadrienLejard).
...
- [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) [155★] - Plugin for displaying local notifications by [Michael Bui](https://github.com/MaikuB).
...
- [Downloader](https://github.com/hnvn/flutter_downloader) [64★] - Create and manage download tasks by [HungHD](https://github.com/hnvn).
- [InAppBrowser](https://github.com/pichillilorenzo/flutter_inappbrowser) [27★] - Open an in-app browser window (porting of cordova inappbrowser) by [Lorenzo Pichilli](https://github.com/pichillilorenzo).
...
- [Fast QR Reader View](https://github.com/facundomedica/fast_qr_reader_view) [30★] - Live multicode reader by [Facundo Medica](https://github.com/facundomedica).

#### Bluetooth / NFC / Beacon

- [Ble](https://github.com/Polidea/FlutterBleLib) [71★] - Bluetooth by [Polidea](http://www.polidea.com).
- [Blue](https://github.com/pauldemarco/flutter_blue) [240★] - Bluetooth by [Paul DeMarco](https://github.com/pauldemarco).
- [Beacons](https://github.com/loup-v/beacons) [12★] - Flutter beacons plugin by [Loup](http://intheloup.io).
- [NFC Reader](https://github.com/matteocrippa/flutter-nfc-reader) [15★] - NFC reader plugin for iOS and Android by [Matteo Crippa](https://github.com/matteocrippa).

### Storage

- [Sqflite](https://github.com/tekartik/sqflite) [432★] - SQLite flutter plugin by [Alexandre Roux](https://www.linkedin.com/in/alextekartik/).
...
- [Redux](https://github.com/brianegan/flutter_redux) [360★] - Built to work with [redux.dart](https://github.com/johnpryan/redux.dart), utilities that allow you to easily consume a Redux Store to build Widgets.
- [Dartea](https://github.com/p69/dartea) [26★] - Model View Update inspired by TEA from ELM by [Shilyagov P](https://github.com/p69).
- [Inject](https://github.com/google/inject.dart) [251★] - Compile-time dependency injection for Dart and Flutter by Google.
- [Flutter_flux](https://github.com/google/flutter_flux) [210★] - Implementation of the Flux framework by Google.

### Data

- [Graphql_flutter](https://github.com/zino-app/graphql-flutter) [266★] - Implementation of the GraphQL spec by [Zino App B.V.](https://github.com/zino-app).

### Animation

- [Sequence Animation](https://github.com/Norbert515/flutter_sequence_animation) [71★] - Composite staggered animations by [Norbert Kozsir](https://twitter.com/norbertkozsir).
- [SpinKit](https://github.com/jogboms/flutter_spinkit) [318★] - Animated loading indicators by [Jeremiah Ogbomo](https://twitter.com/jogboms).
- [Villains](https://github.com/Norbert515/flutter_villains) [82★] - Page transition animations by [Norbert Kozsir](https://twitter.com/norbertkozsir).
- [AnimatedTextKit](https://github.com/aagarwal1012/Animated-Text-Kit) [108★] - A collection of cool text animations by [Ayush Agarwal](https://github.com/aagarwal1012/).

### Game Engine

- [Flame](https://github.com/luanpotter/flame) [336★] - Minimalist game engine by [Luan Nico](https://github.com/luanpotter).
- [SpriteWidget](https://github.com/spritewidget/spritewidget) [328★] - Toolkit for building complex, high performance animations and 2D games by [Viktor Lidholt](https://github.com/vlidholt).

### Misc

- [Cache Manager](https://github.com/renefloor/flutter_cache_manager) [55★] - Generic cache manager by [Rene Floor](https://github.com/renefloor).
...
- [Planets](https://github.com/sergiandreplace/flutter_planets_tutorial) [247★] - Planet exploration that demonstrate rich UI by [Sergi Martínez](http://sergiandreplace.com).
...
- [DroidKaigi2018-flutter](https://github.com/konifar/droidkaigi2018-flutter) [317★] - Unofficial conference app for DroidKaigi 2018 Tokyo by [konifar](https://github.com/konifar).
- [Music Player](https://github.com/iampawan/Flutter-Music-Player) [319★] - Full featured music player by [Pawan Kumar](https://about.me/imthepk).
- [InKino](https://github.com/roughike/inKino) [1106★] - Movie app with flutter_redux, animations and unit tests by [Iiro Krankka](https://github.com/roughike).
- [WhatTodo](https://github.com/burhanrashid52/WhatTodo) [170★] - Todoist like UI by [Burhanuddin Rashid](https://about.me/burhanrashid52).
- [FlutterGram](https://github.com/mdanics/fluttergram) [238★] - Complete Instagram based on Firestore & Google Functions by [MDanics](https://github.com/mdanics).
- [BookSearch](https://github.com/Norbert515/BookSearch) [167★] - Digital BookShelf for your reading progress by [Norbert515](https://github.com/Norbert515).
...
- [Trace](https://github.com/trentpiercy/trace) [97★] - Modern and powerful crypto portfolio & market explorer by [Trent Piercy](https://github.com/trentpiercy).
...
- [Desktop Embedding](https://github.com/google/flutter-desktop-embedding) [1174★] - Desktop implementations of the Flutter embedding API by Google.
...
- [Redux Starter/Code Generator](https://github.com/hillelcoren/flutter-redux-starter) [78★] - Starter project and code generator with Redux support by [Hillel Coren](https://twitter.com/hillelcoren).
...
- [The One](https://www.youtube.com/watch?v=sIIgtClYq0s) [141👍]
