...
<p align="center">
  <a href="https://stackoverflow.com/questions/tagged/flutter?sort=votes">
    <img alt="StackOverflow" src="https://img.shields.io/badge/StackOverflow-6081-orange.svg" />
  </a>
  <a href="https://github.com/search?q=flutter+language%3Adart&type=Repositories">
    <img alt="Github Repositories" src="https://img.shields.io/badge/Repos-9219-brightgreen.svg" />
  </a>
...
- [Securing Apps](https://medium.com/@mehmetf_71205/securing-flutter-apps-ada13e806a69) [287👏] - By Mehmet Fidanboylu.
...
- [Rendering Engine Tutorial](https://medium.com/saugo360/flutters-rendering-engine-a-tutorial-part-1-e9eff68b825d) [173👏] - Flutter's Rendering Engine: A Tutorial by [AbdulRahman AlHamali](https://github.com/AbdulRahmanAlHamali/).
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) [1183★] - Simple basic isolated apps for devs by [Nishant Srivastava](https://github.com/nisrulz).
...
- [Parallax](https://github.com/FlutterRocks/page-transformer) [192★] - ViewPager by [Iiro Krankka](https://github.com/roughike).
- [StaggeredGridView](https://github.com/letsar/flutter_staggered_grid_view) [226★] - GridView with tiles of variable sizes by [Romain Rastel](https://github.com/letsar).
...
- [Radial Menu](https://github.com/xqwzts/flutter_radial_menu) [114★] - Animated Radial Menu by [Victor Choueiri](https://github.com/xqwzts).
...
- [List Drag&Drop](https://github.com/Norbert515/flutter_list_drag_and_drop) [96★] - Reorder list elements using Drag & Drop by [Norbert515](https://github.com/Norbert515).
...
- [Facebook Reactions](https://github.com/duytq94/facebook-reaction-animation) [40★] - Facebook reactions widget by [Duy Tran](https://github.com/duytq94).
- [Flushbar](https://github.com/AndreHaueisen/flushbar) [65★] - Highly configurable Snackbar by [Andre Haueisen](https://github.com/AndreHaueisen).
- [Stepper Touch](https://github.com/Rahiche/stepper_touch) [22★] - Lateral value stepper nicely animated by [Raouf Rahiche](https://github.com/Rahiche).
- [Offline](https://github.com/jogboms/flutter_offline) [74★] - A tidy utility to handle offline/online connectivity by [Jeremiah Ogbomo](https://twitter.com/jogboms).
...
- [Photo View](https://github.com/renancaraujo/photo_view) [133★] - Scalable image view with loading placeholder by [Renan C. Araújo](https://github.com/renancaraujo).
...
- [Cached Network Image](https://github.com/renefloor/flutter_cached_network_image) [160★] - Show images from the internet and keep them in the cache directory by.
...
- [Map](https://github.com/apptreesoftware/flutter_map) [255★] - Solution based on [Leaflet](http://leafletjs.com/) and customizable by [AppTree Software](https://github.com/apptreesoftware).
- [Mapbox GL](https://github.com/mapbox/flutter-mapbox-gl) [132★] - Interactive, customizable vector maps by Mapbox.

### Charts

- [Circular Chart](https://github.com/xqwzts/flutter_circular_chart) [121★] - Animated radial and pie charts by [Victor Choueiri](https://github.com/xqwzts).
...
- [Login](https://github.com/AppleEducate/flutter_login) [158★] - FaceID, TouchID, and Fingerprint Reader by [Rody Davis](http://appleeducate.com).
...
- [Markdown](https://github.com/flutter/flutter_markdown) [102★] - Markdown renderer for Flutter. It supports the original format, but no inline html.
...
- [Chewie](https://github.com/brianegan/chewie) [135★] - Provides low-level access to video playback by [Brian Egan](https://github.com/brianegan).
...
- [Secure Storage](https://github.com/mogol/flutter_secure_storage) [56★] - Keychain and Keystore storage by [German Saprykin](https://github.com/mogol).
...
- [TodoMVC](https://github.com/brianegan/flutter_architecture_samples) [1127★] - TODO application ready to go with different flavors : Vanilla, Redux, built_redux by [Brian Egan](https://github.com/brianegan).
- [Restaurant Menu](https://github.com/braulio94/menu_flutter) [285★] - Restaurant menu by [Braulio Cassule](https://github.com/braulio94).
...
- [UI Kit](https://github.com/iampawan/Flutter-UI-Kit) [1168★] - Collection of useful UIs in a UIKit by [Pawan Kumar](https://github.com/iampawan).
...
- [InAppBrowser](https://github.com/pichillilorenzo/flutter_inappbrowser) [25★] - Open an in-app browser window (porting of cordova inappbrowser) by [Lorenzo Pichilli](https://github.com/pichillilorenzo).
...
- [Sqflite](https://github.com/tekartik/sqflite) [427★] - SQLite flutter plugin by [Alexandre Roux](https://www.linkedin.com/in/alextekartik/).
...
- [Redux](https://github.com/brianegan/flutter_redux) [358★] - Built to work with [redux.dart](https://github.com/johnpryan/redux.dart), utilities that allow you to easily consume a Redux Store to build Widgets.
- [Dartea](https://github.com/p69/dartea) [26★] - Model View Update inspired by TEA from ELM by [Shilyagov P](https://github.com/p69).
- [Inject](https://github.com/google/inject.dart) [250★] - Compile-time dependency injection for Dart and Flutter by Google.
- [Flutter_flux](https://github.com/google/flutter_flux) [210★] - Implementation of the Flux framework by Google.

### Data

- [Graphql_flutter](https://github.com/zino-app/graphql-flutter) [262★] - Implementation of the GraphQL spec by [Zino App B.V.](https://github.com/zino-app).
...
- [Flame](https://github.com/luanpotter/flame) [331★] - Minimalist game engine by [Luan Nico](https://github.com/luanpotter).
...
- [Cache Manager](https://github.com/renefloor/flutter_cache_manager) [54★] - Generic cache manager by [Rene Floor](https://github.com/renefloor).
...
- [Planets](https://github.com/sergiandreplace/flutter_planets_tutorial) [245★] - Planet exploration that demonstrate rich UI by [Sergi Martínez](http://sergiandreplace.com).
...
- [WhatTodo](https://github.com/burhanrashid52/WhatTodo) [168★] - Todoist like UI by [Burhanuddin Rashid](https://about.me/burhanrashid52).
...
- [Desktop Embedding](https://github.com/google/flutter-desktop-embedding) [1163★] - Desktop implementations of the Flutter embedding API by Google.
...
- [The One](https://www.youtube.com/watch?v=sIIgtClYq0s) [140👍]
