...
- [Animated QR Code Scanner](https://github.com/kiatuki/animated_qr_code_scanner) - QR Code Scanner with a nicely-animated detector by [Kiat Stanley](https://github.com/kiatuki).
