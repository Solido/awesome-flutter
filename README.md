...
- [Attendance Assistant](https://github.com/sanattaori/attendance-assistant) - Firebase backend, Take attendance using barcode build for both students and teachers, by [Sanat Taori](https://github.com/sanattaori)
