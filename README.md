...
<p align="center">
  <a href="https://stackoverflow.com/questions/tagged/flutter?sort=votes">
    <img alt="StackOverflow" src="https://img.shields.io/badge/StackOverflow-8220-orange.svg" />
  </a>
  <a href="https://github.com/search?q=flutter+language%3Adart&type=Repositories">
    <img alt="Github Repositories" src="https://img.shields.io/badge/Repos-12932-brightgreen.svg" />
  </a>
  <img alt="Entries" src="https://img.shields.io/badge/Items-228-lightgrey.svg" />
...
- [From Install to ListView](https://medium.com/@develodroid/flutter-i-intro-and-install-a8bf6dfcc7c8) [747 claps👏] - Full series of 4 articles by [Chema Rubio](https://twitter.com/develodroid).
...
- [Zero to One Animation](https://medium.com/dartlang/zero-to-one-with-flutter-part-two-5aa2f06655cb) [903 claps👏] - Focus on animation by [Mikkel Ravn](https://medium.com/@mravn).
...
- [Firebase](https://www.youtube.com/watch?v=p4yLzYwy_4g) [425👍] - Firebase live coding.
...
- [Build Flavor](https://medium.com/@salvatoregiordanoo/flavoring-flutter-392aaa875f36) [767 claps👏] - Define build configurations and switch them by [Salvatore Giordano](https://medium.com/@salvatoregiordanoo).
...
- [Rendering Pipeline](https://www.youtube.com/watch?v=UUfXWzp0-DU) [206👍] - Engine architecture by Adam Barth.
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) [1588⭐] - Simple basic isolated apps for devs by [Nishant Srivastava](https://github.com/nisrulz).
...
- [StaggeredGridView](https://github.com/letsar/flutter_staggered_grid_view) [327⭐] - GridView with tiles of variable sizes by [Romain Rastel](https://github.com/letsar).
- [Sticky Header](https://github.com/letsar/flutter_sticky_header) [128⭐] - Sliver based sticky headers by [Romain Rastel](https://github.com/letsar).
- [Radial Menu](https://github.com/xqwzts/flutter_radial_menu) [133⭐] - Animated Radial Menu by [Victor Choueiri](https://github.com/xqwzts).
...
- [Sticky Headers](https://github.com/slightfoot/flutter_sticky_headers) [182⭐] - Configurable sticky headers by [Simon Lightfoot](http://www.devangels.london/).
- [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation) [306⭐] - Smooth animation from login to home by [Ruchika Gupta](https://github.com/geekruchika).
...
- [Facebook Reactions](https://github.com/duytq94/facebook-reaction-animation) [56⭐] - Facebook reactions widget by [Duy Tran](https://github.com/duytq94).
...
- [Offline](https://github.com/jogboms/flutter_offline) [131⭐] - Tidy utility to handle offline/online connectivity by [Jeremiah Ogbomo](https://twitter.com/jogboms).
...
- [Fluid Slider](https://github.com/rvamsikrishna/flutter_fluid_slider) [53⭐] - A slider with a minimal design and fluid like animation by [Vamsi  Krishna](https://github.com/rvamsikrishna).
...
- [Slidable](https://github.com/letsar/flutter_slidable) [320⭐] - Slidable list item with left and right slide actions by [Romain Rastel](https://github.com/letsar).
...
- [Shimmer](https://github.com/hnvn/flutter_shimmer) [203⭐] - Shimmer effect while content is loading by [HungHD](https://github.com/hnvn).
...
- [Carousel Slider](https://github.com/serenader2014/flutter_carousel_slider) [121⭐] - Carousel slider widget, support infinite scroll and custom child widget by [serenader](https://github.com/serenader2014).
...
- [Photo View](https://github.com/renancaraujo/photo_view) [205⭐] - Scalable image view with loading placeholder by [Renan C. Araújo](https://github.com/renancaraujo).
- [SVG](https://github.com/dnfield/flutter_svg) [184⭐] - SVG parsing, rendering, and widget library by [Dan Field](https://github.com/dnfield).
- [Image Cropper](https://github.com/hnvn/flutter_image_cropper) [162⭐] - Crop your images support ratio, rotation, zoom by [HungHD](https://github.com/hnvn).
- [Cached Network Image](https://github.com/renefloor/flutter_cached_network_image) [247⭐] - Show images from the internet and keep them in the cache directory by.
...
- [Map](https://github.com/apptreesoftware/flutter_map) [442⭐] - Solution based on [Leaflet](http://leafletjs.com/) and customizable by [AppTree Software](https://github.com/apptreesoftware).
- [Mapbox GL](https://github.com/mapbox/flutter-mapbox-gl) [151⭐] - Interactive, customizable vector maps by Mapbox.

### Charts

- [Circular Chart](https://github.com/xqwzts/flutter_circular_chart) [148⭐] - Animated radial and pie charts by [Victor Choueiri](https://github.com/xqwzts).
...
- [Sparkline](https://github.com/xqwzts/flutter_sparkline) [89⭐] - Sparkline by [Victor Choueiri](https://github.com/xqwzts).
- [Charts](https://github.com/google/charts) [382⭐] - By Google Charts Team.
...
- [FCharts](https://github.com/thekeenant/fcharts) [196⭐] - Beautiful, responsive, animated charts by [Keenan Thompson](https://keenant.com).

### Navigation

- [Fluro](https://github.com/goposse/fluro) [598⭐] - The brightest, hippest, coolest router for Flutter with Navigation, wildcard, query, transitions by [Posse](http://goposse.com).
...
- [Login](https://github.com/AppleEducate/flutter_login) [194⭐] - FaceID, TouchID, and Fingerprint Reader by [Rody Davis](http://appleeducate.com).
...
- [SimpleAuth](https://github.com/Clancey/simple_auth) [63⭐] - Azure Active Directory, Amazon, Dropbox, Facebook, Github, Google, Instagram, Linked In, Microsoft Live Connect, Github, OAuth, Basic Auth by [James Clancey](https://github.com/Clancey).

### Text & Rich Content

- [Markdown](https://github.com/flutter/flutter_markdown) [148⭐] - Markdown renderer for Flutter. It supports the original format, but no inline html.
...
- [Zefyr](https://github.com/memspace/zefyr) [281⭐] - Soft and gentle rich text editing by [Memspace](https://github.com/memspace/zefyr).
...
- [Audio Plugin](https://github.com/rxlabz/audioplayer) [176⭐] - Beta by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) [247⭐] - WebRTC plugin for iOS/Android by [CloudWebRtc](https://github.com/cloudwebrtc).
- [Chewie](https://github.com/brianegan/chewie) [187⭐] - Provides low-level access to video playback by [Brian Egan](https://github.com/brianegan).
...
- [Inapp Purchase](https://github.com/dooboolab/flutter_inapp_purchase) [116⭐] - Features set of 'in app purchase' derived from [react-native-iap](https://github.com/dooboolab/react-native-iap) by [dooboolab](https://github.com/dooboolab).
...
- [Movie Details](https://github.com/FlutterRocks/movie-details-ui) [174⭐] - Movie details page by [Iiro Krankka](https://github.com/roughike).
...
- [TodoMVC](https://github.com/brianegan/flutter_architecture_samples) [1577⭐] - TODO application ready to go with different flavors : Vanilla, Redux, built_redux by [Brian Egan](https://github.com/brianegan).
...
- [UI Challenges](https://github.com/tomialagbe/flutter_ui_challenges) [472⭐] - Profile, Travel, Food App by [Tomi Alagbe](https://github.com/tomialagbe).
...
- [Music Player](https://github.com/thosakwe/flutter_music_player) [84⭐] - music player component by [Tobe O](https://thosakwe.com/).
- [Dashboard](https://github.com/Ivaskuu/dashboard) [269⭐] - Dashboard and Shop Items by [Ivascu Adrian](https://github.com/Ivaskuu).
- [Todo](https://github.com/littlemarc2011/FlutterTodo) [191⭐] - Todo template from Dribble by [Marc L](https://www.marc-little.com/).
- [Card Swipe Animation](https://github.com/geekruchika/FlutterCardSwipe) [137⭐] - Swipe cards template by [Ruchika Gupta](https://github.com/geekruchika).
- [UI Kit](https://github.com/iampawan/Flutter-UI-Kit) [1575⭐] - Collection of useful UIs in a UIKit by [Pawan Kumar](https://github.com/iampawan).
- [Book](https://github.com/putraxor/flutter-book-app) [95⭐] - Bookshelf by [Ardiansyah Putra](https://github.com/putraxor).
- [The Gorgeous Login](https://github.com/huextrat/TheGorgeousLogin) [335⭐] - Design and smooth login template by [Hugo Extrat](https://github.com/huextrat).
...
- [DrawApp](https://github.com/SnakeyHips/drawapp) [32⭐] - Sample Drawing App to demonstrate how to allow user to draw onto canvas with color picker and brush thickness slider by [Jake Gough](https://github.com/SnakeyHips).
...
- [WebView](https://github.com/dart-flitter/flutter_webview_plugin) [383⭐] - Render web content by [Hadrien Lejard](https://twitter.com/HadrienLejard).
...
- [Geolocation](https://github.com/loup-v/geolocation) [115⭐] - Fully featured geolocation plugin: current location, location updates, geocode, places and more by [Loup](http://intheloup.io).
...
- [Get Version](https://github.com/AppleEducate/get_version) [31⭐] - Version Name, Version Code, App ID and Platform with OS Version by [Rody Davis](http://appleeducate.com).
...
- [InAppBrowser](https://github.com/pichillilorenzo/flutter_inappbrowser) [112⭐] - Add inline WebView widgets or open an in-app browser window by [Lorenzo Pichilli](https://github.com/pichillilorenzo).
...
- [Blue](https://github.com/pauldemarco/flutter_blue) [325⭐] - Bluetooth by [Paul DeMarco](https://github.com/pauldemarco).
- [Beacons](https://github.com/loup-v/beacons) [15⭐] - Flutter beacons plugin by [Loup](http://intheloup.io).
- [NFC Reader](https://github.com/matteocrippa/flutter-nfc-reader) [34⭐] - NFC reader plugin for iOS and Android by [Matteo Crippa](https://github.com/matteocrippa).

### Storage

- [Sqflite](https://github.com/tekartik/sqflite) [541⭐] - SQLite flutter plugin by [Alexandre Roux](https://www.linkedin.com/in/alextekartik/).
- [MMKV](https://github.com/OpenFlutter/mmkv_flutter) [24⭐] - WeChat ultra fast & persistent key-value storage by [BigBug](https://github.com/yuyongmao).

### Services

- [Google Mobile Vision](https://github.com/edufolly/flutter_mobile_vision) [133⭐] - Google Mobile Vision by [Eduardo Folly](https://github.com/edufolly).
...
- [MLKit](https://github.com/azihsoyn/flutter_mlkit) [119⭐] - Firebase Machine Learning Kit by [Naoya Yoshizawa](https://github.com/azihsoyn).
- [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) [90⭐] - Push notification service by [OneSignal](https://github.com/OneSignal).
- [Place Dialog](https://github.com/pinkfish/flutter_places_dialog) [26⭐] - Places picker dialog returning the places to the app by [David Bennett](https://github.com/pinkfish).
...
- [Bloc](https://github.com/felangel/bloc) [174⭐] - Collection of packages that help implement the BLoC design pattern by [Felix Angelov](https://github.com/felangel).
...
- [Redux.dart](https://github.com/johnpryan/redux.dart) [204⭐] - Port of Redux to Dart with an ecosystem of middleware, Flutter integrations, and time traveling dev tools by [John Ryan](https://github.com/johnpryan) and [Brian Egan](https://gitlab.com/users/brianegan/projects).
- [Redux](https://github.com/brianegan/flutter_redux) [464⭐] - Built to work with [redux.dart](https://github.com/johnpryan/redux.dart), utilities that allow you to easily consume a Redux Store to build Widgets.
- [Dartea](https://github.com/p69/dartea) [54⭐] - Model View Update inspired by TEA from ELM by [Shilyagov P](https://github.com/p69).
- [Inject](https://github.com/google/inject.dart) [295⭐] - Compile-time dependency injection for Dart and Flutter by Google.
- [Flutter_flux](https://github.com/google/flutter_flux) [258⭐] - Implementation of the Flux framework by Google.

### Data

- [Graphql_flutter](https://github.com/zino-app/graphql-flutter) [415⭐] - Implementation of the GraphQL spec by [Zino App B.V.](https://github.com/zino-app).
...
- [SpinKit](https://github.com/jogboms/flutter_spinkit) [410⭐] - Animated loading indicators by [Jeremiah Ogbomo](https://twitter.com/jogboms).
...
- [AnimatedTextKit](https://github.com/aagarwal1012/Animated-Text-Kit) [155⭐] - A collection of cool text animations by [Ayush Agarwal](https://github.com/aagarwal1012/).

### Game Engine

- [Flame](https://github.com/luanpotter/flame) [531⭐] - Minimalist game engine by [Luan Nico](https://github.com/luanpotter).
- [SpriteWidget](https://github.com/spritewidget/spritewidget) [431⭐] - Toolkit for building complex, high performance animations and 2D games by [Viktor Lidholt](https://github.com/vlidholt).

### Misc

- [Cache Manager](https://github.com/renefloor/flutter_cache_manager) [84⭐] - Generic cache manager by [Rene Floor](https://github.com/renefloor).

## Open Source Apps

- [FriendlyChat](https://github.com/flutter/friendlychat-flutter) [187⭐] - Offline/Firebase chat by a team of Googlers.
- [Meme Chat](https://github.com/efortuna/memechat) [301⭐] - Chat app on Flutter, using Firebase, Google Sign In, and device camera integration by a team of Googlers.
...
- [Lime](https://github.com/fablue/lime-flutter) [192⭐] - Lime social network by Sebastian Sellmair.
- [Planets](https://github.com/sergiandreplace/flutter_planets_tutorial) [306⭐] - Planet exploration that demonstrate rich UI by [Sergi Martínez](http://sergiandreplace.com).
...
- [DroidKaigi2018-flutter](https://github.com/konifar/droidkaigi2018-flutter) [342⭐] - Unofficial conference app for DroidKaigi 2018 Tokyo by [konifar](https://github.com/konifar).
- [Music Player](https://github.com/iampawan/Flutter-Music-Player) [401⭐] - Full featured music player by [Pawan Kumar](https://about.me/imthepk).
- [WhatTodo](https://github.com/burhanrashid52/WhatTodo) [294⭐] - Todoist like UI by [Burhanuddin Rashid](https://about.me/burhanrashid52).
- [FlutterGram](https://github.com/mdanics/fluttergram) [322⭐] - Complete Instagram based on Firestore & Google Functions by [MDanics](https://github.com/mdanics).
- [BookSearch](https://github.com/Norbert515/BookSearch) [202⭐] - Digital BookShelf for your reading progress by [Norbert515](https://github.com/Norbert515).
- [Cinematic](https://github.com/aaronoe/FlutterCinematic) [356⭐] - UI for Movie DB Public API by [Aaron Oertel](https://github.com/aaronoe).
...
- [Trace](https://github.com/trentpiercy/trace) [134⭐] - Modern and powerful crypto portfolio & market explorer by [Trent Piercy](https://github.com/trentpiercy).
- [Taskist](https://github.com/huextrat/Taskist) [88⭐] - Taskist is a ToDo List app for Task Management by [Hugo EXTRAT](https://github.com/huextrat).
- [Tourism](https://github.com/bluemix/tourism-demo) [45⭐] - Tourism app based on redux w/ animations & i18n by [blueMix](https://github.com/bluemix/tourism-demo).
- [Trinity Orientation @ Univ Toronto](https://github.com/matthewtory/trinity-orientation-2018) [111⭐] - Orientation week at Trinity College, U of T by [Matthew Tory](https://github.com/matthewtory).
...
- [InKino](https://github.com/roughike/inKino) [1519⭐] - Movie app with flutter_redux, animations and unit tests by [Iiro Krankka](https://github.com/roughike).
...
- [Crush](https://github.com/boeledi/flutter_crush) [72⭐] - How to build a Math-3 game, like Candy Crush, Bejeweled by [Didier Boelens](https://didierboelens.com).
...
- [Redux Starter/Code Generator](https://github.com/hillelcoren/flutter-redux-starter) [120⭐] - Starter project and code generator with Redux support by [Hillel Coren](https://twitter.com/hillelcoren).
...
- [Desktop Embedding](https://github.com/google/flutter-desktop-embedding) [2414⭐] - Desktop implementations of the Flutter embedding API by Google.
- [Golang Desktop Embedder](https://github.com/Drakirus/go-flutter-desktop-embedder) [414⭐] - Golang embedder for desktop by [Pierre Champion](https://github.com/Drakirus).
...
- [The One](https://www.youtube.com/watch?v=sIIgtClYq0s) [184👍]
