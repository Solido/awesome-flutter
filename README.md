...
<p align="center">
  <a href="https://stackoverflow.com/questions/tagged/flutter?sort=votes">
    <img alt="StackOverflow" src="https://img.shields.io/badge/StackOverflow-6031-orange.svg" />
  </a>
  <a href="https://github.com/search?q=flutter+language%3Adart&type=Repositories">
    <img alt="Github Repositories" src="https://img.shields.io/badge/Repos-9123-brightgreen.svg" />
  </a>
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) [1177★] - Simple basic isolated apps for devs by [Nishant Srivastava](https://github.com/nisrulz).

### UI

- [3D Object](https://github.com/hemanthrajv/flutter_3d_obj) [35★] - Renders a wavefront .obj on to a canvas by [Hemanth Raj](https://www.linkedin.com/in/hemanthrajv).
...
- [Sticky Headers](https://github.com/slightfoot/flutter_sticky_headers) [139★] - Configurable sticky headers by [Simon Lightfoot](http://www.devangels.london/).
- [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation) [239★] - Smooth animation from login to home by [Ruchika Gupta](https://github.com/geekruchika).
...
- [Side Header List](https://github.com/renefloor/side_header_list_view) [84★] - Listview with sticky headers by [Rene Floor](https://github.com/renefloor).
- [Shimmer](https://github.com/hnvn/flutter_shimmer) [153★] - Shimmer effect while content is loading by [HungHD](https://github.com/hnvn).
...
- [Slidable](https://github.com/letsar/flutter_slidable) [230★] - Slidable list item with left and right slide actions by [Romain Rastel](https://github.com/letsar).
- [RangeSlider](https://github.com/boeledi/RangeSlider) [40★] - 2-thumb configurable RangeSlider by [Didier Boelens](https://www.didierboelens.com).
...
- [Photo View](https://github.com/renancaraujo/photo_view) [130★] - Scalable image view with loading placeholder by [Renan C. Araújo](https://github.com/renancaraujo).
...
- [Google Map View](https://github.com/apptreesoftware/flutter_google_map_view) [300★] - Displaying google map plugin by [AppTree Software](https://www.linkedin.com/company/apptree-software/).
...
- [Map](https://github.com/apptreesoftware/flutter_map) [248★] - Solution based on [Leaflet](http://leafletjs.com/) and customizable by [AppTree Software](https://github.com/apptreesoftware).
...
- [Fluro](https://github.com/goposse/fluro) [479★] - The brightest, hippest, coolest router for Flutter with Navigation, wildcard, query, transitions by [Posse](http://goposse.com).
...
- [Zefyr](https://github.com/memspace/zefyr) [201★] - Soft and gentle rich text editing by [Memspace](https://github.com/memspace/zefyr).
...
- [Flutterial](https://github.com/rxlabz/flutterial) [68★] - Flutter Material Theme explorer by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [Pigment](https://github.com/bregydoc/pigment) [44★] - Simple but useful package for use colors in flutter.
...
- [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) [197★] - WebRTC plugin for iOS/Android by [CloudWebRtc](https://github.com/cloudwebrtc).
...
- [Speech Recognition](https://github.com/rxlabz/speech_recognition) [59★] - Speech to text by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [Inapp Purchase](https://github.com/dooboolab/flutter_inapp_purchase) [91★] - Features set of 'in app purchase' derived from [react-native-iap](https://github.com/dooboolab/react-native-iap) by [dooboolab](https://github.com/dooboolab).
...
- [Mates](https://github.com/CodemateLtd/FlutterMates) [205★] - How to load profiles from the randomuser.me API and a nice profile details page by [Iiro Krankka](https://github.com/roughike).
...
- [TodoMVC](https://github.com/brianegan/flutter_architecture_samples) [1122★] - TODO application ready to go with different flavors : Vanilla, Redux, built_redux by [Brian Egan](https://github.com/brianegan).
...
- [UI Kit](https://github.com/iampawan/Flutter-UI-Kit) [1163★] - Collection of useful UIs in a UIKit by [Pawan Kumar](https://github.com/iampawan).
...
- [WebView](https://github.com/dart-flitter/flutter_webview_plugin) [304★] - Render web content by [Hadrien Lejard](https://twitter.com/HadrienLejard).
- [Location](https://github.com/Lyokone/flutterlocation) [124★] - Handle location, handling callbacks to get continuous location by [Lyokone](https://github.com/Lyokone).
...
- [Downloader](https://github.com/hnvn/flutter_downloader) [62★] - Create and manage download tasks by [HungHD](https://github.com/hnvn).
...
- [Inject](https://github.com/google/inject.dart) [248★] - Compile-time dependency injection for Dart and Flutter by Google.
- [Flutter_flux](https://github.com/google/flutter_flux) [208★] - Implementation of the Flux framework by Google.

### Data

- [Graphql_flutter](https://github.com/zino-app/graphql-flutter) [258★] - Implementation of the GraphQL spec by [Zino App B.V.](https://github.com/zino-app).
...
- [SpinKit](https://github.com/jogboms/flutter_spinkit) [314★] - Animated loading indicators by [Jeremiah Ogbomo](https://twitter.com/jogboms).
...
- [Flame](https://github.com/luanpotter/flame) [328★] - Minimalist game engine by [Luan Nico](https://github.com/luanpotter).
- [SpriteWidget](https://github.com/spritewidget/spritewidget) [323★] - Toolkit for building complex, high performance animations and 2D games by [Viktor Lidholt](https://github.com/vlidholt).
...
- [DroidKaigi2018-flutter](https://github.com/konifar/droidkaigi2018-flutter) [315★] - Unofficial conference app for DroidKaigi 2018 Tokyo by [konifar](https://github.com/konifar).
- [Music Player](https://github.com/iampawan/Flutter-Music-Player) [317★] - Full featured music player by [Pawan Kumar](https://about.me/imthepk).
- [InKino](https://github.com/roughike/inKino) [1102★] - Movie app with flutter_redux, animations and unit tests by [Iiro Krankka](https://github.com/roughike).
...
- [Desktop Embedding](https://github.com/google/flutter-desktop-embedding) [1151★] - Desktop implementations of the Flutter embedding API by Google.
...
- [Redux Starter/Code Generator](https://github.com/hillelcoren/flutter-redux-starter) [76★] - Starter project and code generator with Redux support by [Hillel Coren](https://twitter.com/hillelcoren).
