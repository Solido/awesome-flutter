...
<p align="center">
  ...
  <a href="https://stackoverflow.com/questions/tagged/flutter?sort=votes">
    <img alt="StackOverflow" src="https://img.shields.io/badge/StackOverflow-3189-orange.svg" />
  </a>
  <a href="https://github.com/search?q=flutter+language%3Adart&type=Repositories">
    <img alt="Github Repositories" src="https://img.shields.io/badge/Repos-4338-blue.svg" />
  </a>
...
- [Google IO 2018](https://medium.com/flutter-io/building-beautiful-flexible-user-interfaces-with-flutter-material-theming-and-official-material-13ae9279ef19) (859 👏) - Building beautiful, flexible user interfaces.
...
- [Zero to One Animation](https://medium.com/dartlang/zero-to-one-with-flutter-part-two-5aa2f06655cb) (726 👏) - Focus on animation by [Mikkel Ravn](https://medium.com/@mravn).
...
- [Firebase](https://www.youtube.com/watch?v=p4yLzYwy_4g) (332 👍) - Firebase live coding.
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) (723 ★) - Simple basic isolated apps for devs by [Nishant Srivastava](https://github.com/nisrulz).
...
- [StaggeredGridView](https://github.com/letsar/flutter_staggered_grid_view) (118 ★) - GridView with tiles of variable sizes by [Romain Rastel](https://github.com/letsar).
...
- [Flip Panel](https://github.com/hnvn/flutter_flip_panel) (21 ★) - Flip panel with built-in animation by [HungHD](https://github.com/hnvn).
...
- [Zoomable Image](https://github.com/perlatus/flutter_zoomable_image) (42 ★) - By Perlatus.
...
- [Flutter Map](https://github.com/apptreesoftware/flutter_map) (147 ★) - Solution based on [Leaflet](http://leafletjs.com/) and customizable by [AppTree Software](https://github.com/apptreesoftware).
...
- [Fluro](https://github.com/goposse/fluro) (297 ★) - The brightest, hippest, coolest router for Flutter with Navigation, wildcard, query, transitions by [Posse](http://goposse.com).
...
- [Chewie](https://github.com/brianegan/chewie) (75 ★) - Provides low-level access to video playback by [Brian Egan](https://github.com/brianegan).
...
- [Flutter Mates](https://github.com/CodemateLtd/FlutterMates) (163 ★) - How to load profiles from the randomuser.me API and a nice profile details page by [Iiro Krankka](https://github.com/roughike).
...
- [TodoMVC](https://github.com/brianegan/flutter_architecture_samples) (654 ★) - TODO application ready to go with different flavors : Vanilla, Redux, built_redux by [Brian Egan](https://github.com/brianegan).
...
- [UI Challenges](https://github.com/tomialagbe/flutter_ui_challenges) (226 ★) - Profile, Travel, Food App by [Tomi Alagbe](https://github.com/tomialagbe).
...
- [Card Swipe Animation](https://github.com/geekruchika/FlutterCardSwipe) (50 ★) - Swipe cards template by [Ruchika Gupta](https://github.com/geekruchika).

## Plugins

- [Flutter Plugins](https://github.com/flutter/plugins/tree/master/packages) - Official Flutter Team Plugins.
- [Sqflite](https://github.com/tekartik/sqflite) (226 ★) - SQLite flutter plugin by [Alexandre Roux](https://www.linkedin.com/in/alextekartik/).
- [WebView](https://github.com/dart-flitter/flutter_webview_plugin) (156 ★) - by [Hadrien Lejard](https://twitter.com/HadrienLejard).
...
- [Cached Network Image](https://github.com/renefloor/flutter_cached_network_image) (64 ★) - Show images from the internet and keep them in the cache directory by [Rene Floor](https://github.com/renefloor).
...
- [Flutter_redux](https://github.com/brianegan/flutter_redux) (188 ★) - Built to work with [redux.dart](https://github.com/johnpryan/redux.dart), utilities that allow you to easily consume a Redux Store to build Flutter Widgets.
...
- [Sequence Animation](https://github.com/Norbert515/flutter_sequence_animation) (25 ★) - Composite staggered animations by [Norbert Kozsir](https://twitter.com/norbertkozsir).

### Game

- [Flame](https://github.com/luanpotter/flame) (181 ★) - Minimalist game engine by [Luan Nico](https://github.com/luanpotter).
...
- [Meme Chat](https://github.com/efortuna/memechat) (247 ★) - Chat app on Flutter, using Firebase, Google Sign In, and device camera integration by a team of Googlers.
...
- [Lime](https://github.com/fablue/lime-flutter) (131 ★) - Lime social network by Sebastian Sellmair.
- [Planets-Flutter](https://github.com/sergiandreplace/flutter_planets_tutorial) (152 ★) - Planet exploration that demonstrate rich UI by [Sergi Martínez](http://sergiandreplace.com).
- [NewsBuzz](https://github.com/theankurkedia/NewsBuzz) (182 ★) - Firebase backed news reader using News API by [Ankur Kedia](https://github.com/theankurkedia).
...
- [InKino](https://github.com/roughike/inKino) (834 ★) - Complete movie app that uses flutter_redux for state management, has nice transition animations, and a comprehensive set of widget & unit tests, by [Iiro Krankka](https://github.com/roughike).
- [WhatTodo](https://github.com/burhanrashid52/WhatTodo) (107 ★) - Todoist like UI by [Burhanuddin Rashid](https://about.me/burhanrashid52).
- [FlutterGram](https://github.com/mdanics/fluttergram) (77 ★) - Complete Instagram based on Firestore & Google Functions by [MDanics](https://github.com/mdanics).
...
- [Cinematic](https://github.com/aaronoe/FlutterCinematic) (150 ★) - UI for Movie DB Public API by [Aaron Oertel](https://github.com/aaronoe).
- [Beer-Me-Up](https://github.com/benoitletondor/Beer-Me-Up) (87 ★) - Beer tracking nicely designed by [Benoit Letondor](https://github.com/benoitletondor).
