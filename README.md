...
<p align="center">
  ...
  <a href="https://stackoverflow.com/questions/tagged/flutter?sort=votes">
    <img alt="StackOverflow" src="https://img.shields.io/badge/StackOverflow-3079-orange.svg" />
  </a>
  <a href="https://github.com/search?q=flutter+language%3Adart&type=Repositories">
    <img alt="Github Repositories" src="https://img.shields.io/badge/Repos-4199-blue.svg" />
  </a>
  <img alt="Entries" src="https://img.shields.io/badge/Items-159-lightgrey.svg" />
...
- [Google IO 2018](https://medium.com/flutter-io/building-beautiful-flexible-user-interfaces-with-flutter-material-theming-and-official-material-13ae9279ef19) (856 👏) - Building beautiful, flexible user interfaces.
...
- [From Install to ListView](https://medium.com/@develodroid/flutter-i-intro-and-install-a8bf6dfcc7c8) (551 👏) - Full series of 4 articles by [Chema Rubio](https://twitter.com/develodroid).
...
- [Zero to One Animation](https://medium.com/dartlang/zero-to-one-with-flutter-part-two-5aa2f06655cb) (720 👏) - Focus on animation by [Mikkel Ravn](https://medium.com/@mravn).
...
- [Firebase](https://www.youtube.com/watch?v=p4yLzYwy_4g) (324 👍) - Firebase live coding.
- [Securing Apps](https://medium.com/@mehmetf_71205/securing-flutter-apps-ada13e806a69) (231 👏) - By Mehmet Fidanboylu.
- [Build your plugins](https://medium.com/@KarthikPonnam/build-your-own-plugin-for-flutter-cfee1a08ea3a) (291 👏) - How to make a custom plug-in by [Karthik Ponnam](https://medium.com/@KarthikPonnam).
- [Build Flavor](https://medium.com/@salvatoregiordanoo/flavoring-flutter-392aaa875f36) (257 👏) - Define build configurations and switch them by [Salvatore Giordano](https://medium.com/@salvatoregiordanoo).
...
- [Mtechviral](https://www.youtube.com/watch?v=qWL1lGchpRA&list=PLR2qQy0Zxs_UdqAcaipPR3CG1Ly57UlhV) (70 🎬) - [Hindi/English] Mtechviral Series By [Pawan Kumar](https://github.com/iampawan).
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) (704 ★) - Simple basic isolated apps for devs by [Nishant Srivastava](https://github.com/nisrulz).

### UI

- [Color Picker](https://github.com/dart-flitter/flutter_color_picker) (5 ★) - Primary, Accent & RGB colors selection by [Hadrien Lejard](https://twitter.com/HadrienLejard).
...
- [StaggeredGridView](https://github.com/letsar/flutter_staggered_grid_view) (114 ★) - GridView with tiles of variable sizes by [Romain Rastel](https://github.com/letsar).
- [Sticky Header](https://github.com/letsar/flutter_sticky_header) (9 ★) - Sliver based sticky headers by [Romain Rastel](https://github.com/letsar).
- [Radial Menu](https://github.com/xqwzts/flutter_radial_menu) (76 ★) - Animated Radial Menu by [Victor Choueiri](https://github.com/xqwzts).
...
- [Sticky Headers](https://github.com/slightfoot/flutter_sticky_headers) (72 ★) - Configurable sticky headers by [Simon Lightfoot](http://www.devangels.london/).
- [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation) (118 ★) - Smooth animation from login to home by [Ruchika Gupta](https://github.com/geekruchika).
- [List Drag&Drop](https://github.com/Norbert515/flutter_list_drag_and_drop) (54 ★) - Reorder list elements using Drag & Drop by [Norbert515](https://github.com/Norbert515).
- [Calendar Widget](https://github.com/pinkfish/flutter_calendar) (7 ★) - Calendar widget by [David Bennett](https://github.com/pinkfish).
...
- [Shimmer](https://github.com/hnvn/flutter_shimmer) (54 ★) - Shimmer effect while content is loading by [HungHD](https://github.com/hnvn).
...
- [Google Map View](https://github.com/apptreesoftware/flutter_google_map_view) (173 ★) - Displaying google map plugin by [AppTree Software](https://www.linkedin.com/company/apptree-software/).
...
- [Flutter Map](https://github.com/apptreesoftware/flutter_map) (141 ★) - Solution based on [Leaflet](http://leafletjs.com/) and customizable by [AppTree Software](https://github.com/apptreesoftware).
- [Mapbox GL](https://github.com/mapbox/flutter-mapbox-gl) (70 ★) - Interactive, customizable vector maps by Mapbox.

#### Charts

- [Circular Chart](https://github.com/xqwzts/flutter_circular_chart) (78 ★) - Animated radial and pie charts by [Victor Choueiri](https://github.com/xqwzts).
...
- [Fluro](https://github.com/goposse/fluro) (290 ★) - The brightest, hippest, coolest router for Flutter with Navigation, wildcard, query, transitions by [Posse](http://goposse.com).
...
- [Flutter Markdown](https://github.com/flutter/flutter_markdown) (63 ★) - Markdown renderer for Flutter. It supports the original format, but no inline html.
- [Rich Text Editor](https://github.com/long1eu/rich_editor) (42 ★) - Text editor with style by [Lung Razvan](https://github.com/long1eu).

### Analytics

- [Usage](https://github.com/dart-lang/usage) (34 ★) - Google Analytics wrapper for command-line, web, and Flutter apps.
...
- [Flutterial](https://github.com/rxlabz/flutterial) (46 ★) - Flutter Material Theme explorer by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [Pigment](https://github.com/bregydoc/pigment) (27 ★) - Simple but useful package for use colors in flutter.

### Media

- [Audio Plugin](https://github.com/rxlabz/audioplayer) (94 ★) - Beta by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [Stereo](https://github.com/2find/stereo) (22 ★) - Playing music on iOS and Android by [2Find](https://github.com/2find).
...
- [Flutter Mates](https://github.com/CodemateLtd/FlutterMates) (160 ★) - How to load profiles from the randomuser.me API and a nice profile details page by [Iiro Krankka](https://github.com/roughike).
...
- [TodoMVC](https://github.com/brianegan/flutter_architecture_samples) (642 ★) - TODO application ready to go with different flavors : Vanilla, Redux, built_redux by [Brian Egan](https://github.com/brianegan).
- [Restaurant Menu](https://github.com/braulio94/menu_flutter) (218 ★) - Restaurant menu by [Braulio Cassule](https://github.com/braulio94).
- [UI Challenges](https://github.com/tomialagbe/flutter_ui_challenges) (218 ★) - Profile, Travel, Food App by [Tomi Alagbe](https://github.com/tomialagbe).
...
- [Dashboard](https://github.com/Ivaskuu/dashboard) (141 ★) - Dashboard and Shop Items by [Ivascu Adrian](https://github.com/Ivaskuu).
- [Todo](https://github.com/littlemarc2011/FlutterTodo) (93 ★) - Todo template from Dribble by [Marc L](https://www.marc-little.com/).
- [Card Swipe Animation](https://github.com/geekruchika/FlutterCardSwipe) (34 ★) - Swipe cards template by [Ruchika Gupta](https://github.com/geekruchika).

## Plugins

- [Flutter Plugins](https://github.com/flutter/plugins/tree/master/packages) - Official Flutter Team Plugins.
- [Sqflite](https://github.com/tekartik/sqflite) (222 ★) - SQLite flutter plugin by [Alexandre Roux](https://www.linkedin.com/in/alextekartik/).
- [WebView](https://github.com/dart-flitter/flutter_webview_plugin) (150 ★) - by [Hadrien Lejard](https://twitter.com/HadrienLejard).
- [Pub Plugins](https://pub.dartlang.org/flutter/plugins) - Plugins filter in Dart Pub Repository.
- [Flutter Location](https://github.com/Lyokone/flutterlocation) (79 ★) - Handle location, handling callbacks to get continuous location by [Lyokone](https://github.com/Lyokone).
- [QR Code Reader](https://github.com/villela/flutter_qrcode_reader) (32 ★) - QR Code reader plugin by [Matheus Villela](https://github.com/villela).
...
- [Geolocation](https://github.com/loup-v/geolocation) (72 ★) - Fully featured geolocation plugin: current location, location updates, geocode, places and more by [Loup](http://intheloup.io).
- [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) (62 ★) - Plugin for displaying local notifications by [Michael Bui](https://github.com/MaikuB).
...
- [App Rating](https://github.com/AppleEducate/app_review) (20 ★) - Requesting and Writing Reviews for the App Store and Google Play by [Rody Davis](http://appleeducate.com).
...
- [Flutter Blue](https://github.com/pauldemarco/flutter_blue) (141 ★) - Bluetooth by [Paul DeMarco](https://github.com/pauldemarco).
...
- [Redux.dart](https://github.com/johnpryan/redux.dart) (115 ★) - Port of Redux to Dart with an ecosystem of middleware, Flutter integrations, and time traveling dev tools by [John Ryan](https://github.com/johnpryan) and [Brian Egan](https://gitlab.com/users/brianegan/projects).
- [Flutter_redux](https://github.com/brianegan/flutter_redux) (182 ★) - Built to work with [redux.dart](https://github.com/johnpryan/redux.dart), utilities that allow you to easily consume a Redux Store to build Flutter Widgets.
...
- [Flame](https://github.com/luanpotter/flame) (176 ★) - Minimalist game engine by [Luan Nico](https://github.com/luanpotter).
- [SpriteWidget](https://github.com/spritewidget/spritewidget) (226 ★) - Toolkit for building complex, high performance animations and 2D games by [Viktor Lidholt](https://github.com/vlidholt).
...
- [Meme Chat](https://github.com/efortuna/memechat) (244 ★) - Chat app on Flutter, using Firebase, Google Sign In, and device camera integration by a team of Googlers.
...
- [Lime](https://github.com/fablue/lime-flutter) (129 ★) - Lime social network by Sebastian Sellmair.
- [Planets-Flutter](https://github.com/sergiandreplace/flutter_planets_tutorial) (149 ★) - Planet exploration that demonstrate rich UI by [Sergi Martínez](http://sergiandreplace.com).
- [NewsBuzz](https://github.com/theankurkedia/NewsBuzz) (175 ★) - Firebase backed news reader using News API by [Ankur Kedia](https://github.com/theankurkedia).
- [DroidKaigi2018-flutter](https://github.com/konifar/droidkaigi2018-flutter) (225 ★) - Unofficial conference app for DroidKaigi 2018 Tokyo by [konifar](https://github.com/konifar).
- [Music Player](https://github.com/iampawan/Flutter-Music-Player) (178 ★) - Full featured music player by [Pawan Kumar](https://about.me/imthepk).
- [InKino](https://github.com/roughike/inKino) (819 ★) - Complete movie app that uses flutter_redux for state management, has nice transition animations, and a comprehensive set of widget & unit tests, by [Iiro Krankka](https://github.com/roughike).
...
- [FlutterGram](https://github.com/mdanics/fluttergram) (72 ★) - Complete Instagram based on Firestore & Google Functions by [MDanics](https://github.com/mdanics).
...
- [Cinematic](https://github.com/aaronoe/FlutterCinematic) (144 ★) - UI for Movie DB Public API by [Aaron Oertel](https://github.com/aaronoe).
- [Beer-Me-Up](https://github.com/benoitletondor/Beer-Me-Up) (69 ★) - Beer tracking nicely designed by [Benoit Letondor](https://github.com/benoitletondor).
...
- [Desktop Embedding](https://github.com/google/flutter-desktop-embedding) (571 ★) - Desktop implementations of the Flutter embedding API by Google.
