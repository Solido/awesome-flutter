...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) (711 ★) - Simple basic isolated apps for devs by [Nishant Srivastava](https://github.com/nisrulz).
...
- [StaggeredGridView](https://github.com/letsar/flutter_staggered_grid_view) (116 ★) - GridView with tiles of variable sizes by [Romain Rastel](https://github.com/letsar).
- [Sticky Header](https://github.com/letsar/flutter_sticky_header) (30 ★) - Sliver based sticky headers by [Romain Rastel](https://github.com/letsar).
...
- [Sticky Headers](https://github.com/slightfoot/flutter_sticky_headers) (75 ★) - Configurable sticky headers by [Simon Lightfoot](http://www.devangels.london/).
- [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation) (121 ★) - Smooth animation from login to home by [Ruchika Gupta](https://github.com/geekruchika).
...
- [FCharts](https://github.com/thekeenant/fcharts) (118 ★) - Beautiful, responsive, animated charts by [Keenan Thompson](https://keenant.com).


### Navigation

- [Fluro](https://github.com/goposse/fluro) (296 ★) - The brightest, hippest, coolest router for Flutter with Navigation, wildcard, query, transitions by [Posse](http://goposse.com).
...
- [Flutterial](https://github.com/rxlabz/flutterial) (47 ★) - Flutter Material Theme explorer by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [Dashboard](https://github.com/Ivaskuu/dashboard) (145 ★) - Dashboard and Shop Items by [Ivascu Adrian](https://github.com/Ivaskuu).
- [Todo](https://github.com/littlemarc2011/FlutterTodo) (96 ★) - Todo template from Dribble by [Marc L](https://www.marc-little.com/).
- [Card Swipe Animation](https://github.com/geekruchika/FlutterCardSwipe) (46 ★) - Swipe cards template by [Ruchika Gupta](https://github.com/geekruchika).

## Plugins

- [Flutter Plugins](https://github.com/flutter/plugins/tree/master/packages) - Official Flutter Team Plugins.
- [Sqflite](https://github.com/tekartik/sqflite) (224 ★) - SQLite flutter plugin by [Alexandre Roux](https://www.linkedin.com/in/alextekartik/).
- [WebView](https://github.com/dart-flitter/flutter_webview_plugin) (155 ★) - by [Hadrien Lejard](https://twitter.com/HadrienLejard).
...
- [Geolocation](https://github.com/loup-v/geolocation) (73 ★) - Fully featured geolocation plugin: current location, location updates, geocode, places and more by [Loup](http://intheloup.io).
- [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) (64 ★) - Plugin for displaying local notifications by [Michael Bui](https://github.com/MaikuB).
...
- [Sequence Animation](https://github.com/Norbert515/flutter_sequence_animation) (19 ★) - Composite staggered animations by [Norbert Kozsir](https://twitter.com/norbertkozsir).

### Game

- [Flame](https://github.com/luanpotter/flame) (178 ★) - Minimalist game engine by [Luan Nico](https://github.com/luanpotter).
...
- [WhatTodo](https://github.com/burhanrashid52/WhatTodo) (106 ★) - Todoist like UI by [Burhanuddin Rashid](https://about.me/burhanrashid52).
...
- [FlutterGames](https://github.com/searchy2/FlutterGames) (35 ★) - Flutter app for purchasing and renting games, by [Ray Li](https://github.com/searchy2).
