...
<p align="center">
  ...
  <a href="https://stackoverflow.com/questions/tagged/flutter?sort=votes">
    <img alt="StackOverflow" src="https://img.shields.io/badge/StackOverflow-3013-orange.svg" />
  </a>
  <a href="https://github.com/search?q=flutter+language%3Adart&type=Repositories">
    <img alt="Github Repositories" src="https://img.shields.io/badge/Repos-4120-blue.svg" />
  </a>
...
- [Google IO 2018](https://medium.com/flutter-io/building-beautiful-flexible-user-interfaces-with-flutter-material-theming-and-official-material-13ae9279ef19) (853 👏) - Building beautiful, flexible user interfaces.
...
- [Zero to One Animation](https://medium.com/dartlang/zero-to-one-with-flutter-part-two-5aa2f06655cb) (719 👏) - Focus on animation by [Mikkel Ravn](https://medium.com/@mravn).
...
- [Firebase](https://www.youtube.com/watch?v=p4yLzYwy_4g) (320 👍) - Firebase live coding.
- [Securing Apps](https://medium.com/@mehmetf_71205/securing-flutter-apps-ada13e806a69) (230 👏) - By Mehmet Fidanboylu.
- [Build your plugins](https://medium.com/@KarthikPonnam/build-your-own-plugin-for-flutter-cfee1a08ea3a) (276 👏) - How to make a custom plug-in by [Karthik Ponnam](https://medium.com/@KarthikPonnam).
- [Build Flavor](https://medium.com/@salvatoregiordanoo/flavoring-flutter-392aaa875f36) (256 👏) - Define build configurations and switch them by [Salvatore Giordano](https://medium.com/@salvatoregiordanoo).
...
- [Mtechviral](https://www.youtube.com/watch?v=qWL1lGchpRA&list=PLR2qQy0Zxs_UdqAcaipPR3CG1Ly57UlhV) (69 🎬) - [Hindi/English] Mtechviral Series By [Pawan Kumar](https://github.com/iampawan).
...
- [Bram Vanbilsen](https://www.youtube.com/watch?v=CEPCGXQ7IQg&list=PLxU9Ryxq6p58PsNmJL70J4_7UzfSqf35n) (12 🎬) - Discover SDK using VSCode by Bram Vanbilsen.
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) (691 ★) - Simple basic isolated apps for devs by [Nishant Srivastava](https://github.com/nisrulz).
...
- [Parallax](https://github.com/FlutterRocks/page-transformer) (109 ★) - ViewPager by [Iiro Krankka](https://github.com/roughike).
...
- [StaggeredGridView](https://github.com/letsar/flutter_staggered_grid_view) (111 ★) - GridView with tiles of variable sizes by [Romain Rastel](https://github.com/letsar).
...
- [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation) (116 ★) - Smooth animation from login to home by [Ruchika Gupta](https://github.com/geekruchika).
...
- [Calendar Widget](https://github.com/pinkfish/flutter_calendar) (6 ★) - Calendar widget by [David Bennett](https://github.com/pinkfish).
...
- [Zoomable Image](https://github.com/perlatus/flutter_zoomable_image) (40 ★) - By Perlatus.
...
- [Parallax Image](https://github.com/pulyaevskiy/parallax-image) (52 ★) - Image parallax by [Anatoly Pulyaevskiy](https://github.com/pulyaevskiy).
- [Image Placeholder](https://github.com/FaisalAbid/pluto) (15 ★) - While large images load, show a fallback asset by [Faisal Abid](https://twitter.com/FaisalAbid).
...
- [Circular Chart](https://github.com/xqwzts/flutter_circular_chart) (76 ★) - Animated radial and pie charts by [Victor Choueiri](https://github.com/xqwzts).
...
- [Fluro](https://github.com/goposse/fluro) (289 ★) - The brightest, hippest, coolest router for Flutter with Navigation, wildcard, query, transitions by [Posse](http://goposse.com).
...
- [Facebook Login](https://github.com/roughike/flutter_facebook_login) (61 ★) - Authenticate with native Android & iOS Facebook login SDKs by [Iiro Krankka](https://github.com/roughike).
- [Flutter OAuth](https://github.com/hitherejoe/FlutterOAuth) (42 ★) - Buffer, Strava, Unsplash, Github OAuth by [Joe Birch](http://www.hitherejoe.com).
...
- [Flutterial](https://github.com/rxlabz/flutterial) (45 ★) - Flutter Material Theme explorer by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [Audio Plugin](https://github.com/rxlabz/audioplayer) (89 ★) - Beta by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [Video Launcher](https://github.com/rxlabz/flutter_video_launcher) (17 ★) - Launch a video player by [Erick Ghaumez](https://twitter.com/rxlabz).
- [Stereo](https://github.com/2find/stereo) (22 ★) - Playing music on iOS and Android by [2Find](https://github.com/2find).
- [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) (78 ★) - WebRTC plugin for iOS/Android by [CloudWebRtc](https://github.com/cloudwebrtc).
- [Chewie](https://github.com/brianegan/chewie) (69 ★) - Provides low-level access to video playback by [Brian Egan](https://github.com/brianegan).

#### Voice

- [Speech Recognition](https://github.com/rxlabz/speech_recognition) (40 ★) - Speech to text by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [Secure Storage](https://github.com/mogol/flutter_secure_storage) (22 ★) - Keychain and Keystore storage by [German Saprykin](https://github.com/mogol).
...
- [Todo](https://github.com/littlemarc2011/FlutterTodo) (89 ★) - Todo template from Dribble by [Marc L](https://www.marc-little.com/).
...
- [Geolocation](https://github.com/loup-v/geolocation) (69 ★) - Fully featured geolocation plugin: current location, location updates, geocode, places and more by [Loup](http://intheloup.io).
- [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) (59 ★) - Plugin for displaying local notifications by [Michael Bui](https://github.com/MaikuB).
...
- [Downloader](https://github.com/hnvn/flutter_downloader) (21 ★) - Create and manage download tasks by [HungHD](https://github.com/hnvn).
...
- [Flutter Ble](https://github.com/Polidea/FlutterBleLib) (44 ★) - Bluetooth by [Polidea](http://www.polidea.com).
...
- [Flutter_redux](https://github.com/brianegan/flutter_redux) (180 ★) - Built to work with [redux.dart](https://github.com/johnpryan/redux.dart), utilities that allow you to easily consume a Redux Store to build Flutter Widgets.
...
- [Flutter_flux](https://github.com/google/flutter_flux) (165 ★) - Implementation of the Flux framework by Google.

### Animation

- [Sequence Animation](https://github.com/Norbert515/flutter_sequence_animation) (15 ★) - Composite staggered animations by [Norbert Kozsir](https://twitter.com/norbertkozsir).
...
- [Cinematic](https://github.com/aaronoe/FlutterCinematic) (142 ★) - UI for Movie DB Public API by [Aaron Oertel](https://github.com/aaronoe).
- [Beer-Me-Up](https://github.com/benoitletondor/Beer-Me-Up) (21 ★) - Beer tracking nicely designed by [Benoit Letondor](https://github.com/benoitletondor).
...
- [Desktop Embedding](https://github.com/google/flutter-desktop-embedding) (561 ★) - Desktop implementations of the Flutter embedding API by Google.
