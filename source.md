...
- [Flick](https://github.com/aliyigitbireroglu/flutter-flick) <!--stargazers:aliyigitbireroglu/flutter-flick--> - An extensive flick tool/widget for Flutter that allows very flexible flick management for your widgets. It is designed to work flawlessly with snap but it can be used as a standalone package too by [Ali Yigit Bireroglu](https://github.com/aliyigitbireroglu).
