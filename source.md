...
- [Using Clean Architecture in Flutter](https://codeburst.io/using-clean-architecture-in-flutter-d0437d0c7f87) - An article on why clean architecture is so important and how to use it in a Flutter app by [Ugurcan Yildirim](https://medium.com/@ugurcany).
