...
- [HeatMap Calendar](https://github.com/pedrohff/flutter_heatmap_calendar) - Calendar graph used to display spread of data through time, by [Pedro Feitosa](https://github.com/pedrohff)
