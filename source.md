...
- [Flutter Chat UI](https://github.com/flyerhq/flutter_chat_ui) - A community-driven chat UI implementation with an optional [Firebase BaaS](https://github.com/flyerhq/flutter_firebase_chat_core) by the [Flyer Chat team](https://github.com/flyerhq)
