...
- [Frideos](https://github.com/frideosapps/frideos_flutter) - A set of helpers to simplify the using of streams and BLoC pattern, and various widgets (blur, transitions, timed widgets, etc.). by [Francesco Mineo](https://github.com/frideosapps)
