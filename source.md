...
- [Awesome Select](https://github.com/akbarpulatov/flutter_awesome_select) - Easily create your single and multiple choice widgets, such as radio, checkbox, switch, chips, or even custom input. Inspired by Smart Select component from [Framework7](https://framework7.io/) by [Akbar Pulatov and Irfan Vigma Taufik](https://github.com/akbarpulatov).
